...
class PatternBuilderTest {
    ...
    void buildRepeatTimePattern() {
        GroupPattern timePattern = patternBuilder.buildRepeatTimePattern(localisationService.getCurrentLocale());
    ...
    void buildTimePattern() {
        GroupPattern timePattern = patternBuilder.buildTimePattern(localisationService.getCurrentLocale());
    ...
    void buildOffsetTimePattern() {
        GroupPattern timePattern = patternBuilder.buildOffsetTimePattern(localisationService.getCurrentLocale());
