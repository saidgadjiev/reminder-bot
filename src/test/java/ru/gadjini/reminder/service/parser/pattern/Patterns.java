...
class Patterns {
    ...
    static final Pattern OFFSET_TIME_PATTERN = Pattern.compile("((\\b(?<hour>2[0-3]|[01]?[0-9])(:(?<minute>[0-5]?[0-9]))?\\b ?)(в ?)?)?((((мин|минут[ы]?) )(?<prefixminutes>\\d+)|(?<suffixminutes>\\d+)(мин|минут[ы]?)( )?)?(( )?((?<onehour>час)|((ч|час[а-я]{0,2}) )(?<prefixhours>\\d+)|(?<suffixhours>\\d+)(ч|час[а-я]{1,2})( )?))?(( )?((?<oneday>день)|((д|дн[а-я]{1,2}) )(?<prefixdays>\\d+)|(?<suffixdays>\\d+)(д|дн[а-я]{1,2})))?) (?<type>\\b(через|на|за|накануне)\\b)");
    static final Pattern REPEAT_TIME_PATTERN = Pattern.compile("((\\b(?<hour>2[0-3]|[01]?[0-9])(:(?<minute>[0-5]?[0-9]))?\\b ?)(в ?)?)?(((((мин|минут[ы]?) )(?<prefixminutes>\\d+)|(?<suffixminutes>\\d+)(мин|минут[ы]?)( )?)?(( )?(((ч|час[а-я]{0,2}) )(?<prefixhours>\\d+)|(?<suffixhours>\\d+)(ч|час[а-я]{1,2})( )?))?(( )?(((д|дн[а-я]{1,2}) )(?<prefixdays>\\d+)|(?<suffixdays>\\d+)(д|дн[а-я]{1,2})))?)|(?<everyhour>час)|(?<everyday>день)|(((числа )?(?<everymonthday>\\d+)(числа)?) ((?<everymonth>месяц)|((м|месяц[а-я]{0,2} )?(?<months>\\d+)(м|месяц[а-я]{0,2})?)))|((?<monthword>января|февраля|марта|апреля|мая|июня|июля|августа|сентября|октября|ноября|декабря) (?<day>\\d+)( (?<everyyear>год))?)|(?<everyminute>минуту)|(?<dayofweek>понедельник[а]?|вторник[а]?|сред[ыу]?|четверг[а]?|пятниц[ыу]?|суббот[ыу]?|воскресень[яе]?|пн|вт|ср|чт|пт|сб|вс)) кажд[а-я]{0,2}");
