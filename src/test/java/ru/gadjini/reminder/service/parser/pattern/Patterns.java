...
public class Patterns {
    ...
    public static final Pattern OFFSET_TIME_PATTERN = Pattern.compile("((\\b(?<hour>2[0-3]|[01]?[0-9])(:(?<minute>[0-5]?[0-9]))?\\b ?)(в ?)?)?((?<oneminute>минуту)|(((минут[ы]?|мин) )(?<prefixminutes>\\d+)|(?<suffixminutes>\\d+)(минут[ы]?|мин)( )?)?(( )?((?<onehour>час)|((час[а-я]{1,2}|ч) )(?<prefixhours>\\d+)|(?<suffixhours>\\d+)(час[а-я]{1,2}|ч)( )?))?(( )?((?<oneday>день)|((дн[а-я]{1,2}|д) )(?<prefixdays>\\d+)|(?<suffixdays>\\d+)(дн[а-я]{1,2}|д)))?(( )?((((?<weeksdayofweek>понедельник[а-я]?|вторник[а-я]?|сред[[а-я][а-я]]?|четверг[а-я]?|пятниц[[а-я][а-я]]?|суббот[[а-я][а-я]]?|воскресень[[а-я][а-я]]?|пн|вт|ср|чт|пт|сб|вс) )((во|в) ?)?)?((?<oneweek>недел[а-я])|((недел[а-я]{1,2}|н) )(?<prefixweeks>\\d+)|(?<suffixweeks>\\d+)(недел[а-я]{1,2}|н))))?(( )?((?<onemonth>месяц)|((месяц[а-я]{1,2}|м) )(?<prefixmonths>\\d+)|(?<suffixmonths>\\d+)(месяц[а-я]{1,2}|м)))?(( )?((?<oneyear>год)|((год[а-я]{1,2}|лет|г) )(?<prefixyears>\\d+)|(?<suffixyears>\\d+)(год[а-я]{1,2}|лет|г)))?) (?<type>\\b(накануне|через|за|на)\\b)");
    public static final Pattern REPEAT_TIME_PATTERN = Pattern.compile("((\\b(?<hour>2[0-3]|[01]?[0-9])(:(?<minute>[0-5]?[0-9]))?\\b ?)(в ?)?)?((?<oneminute>минуту)|((((минут[ы]?|мин) )(?<prefixminutes>\\d+)|(?<suffixminutes>\\d+)(минут[ы]?|мин)( )?)?(( )?((?<onehour>час)|((час[а-я]{1,2}|ч) )(?<prefixhours>\\d+)|(?<suffixhours>\\d+)(час[а-я]{1,2}|ч)( )?))?(( )?((?<oneday>день)|((дн[а-я]{1,2}|д) )(?<prefixdays>\\d+)|(?<suffixdays>\\d+)(дн[а-я]{1,2}|д)))?(( )?((((?<weeksdayofweek>понедельник[а-я]?|вторник[а-я]?|сред[[а-я][а-я]]?|четверг[а-я]?|пятниц[[а-я][а-я]]?|суббот[[а-я][а-я]]?|воскресень[[а-я][а-я]]?|пн|вт|ср|чт|пт|сб|вс) )((во|в) ?)?)?((?<oneweek>недел[а-я])|((недел[а-я]{1,2}|н) )(?<prefixweeks>\\d+)|(?<suffixweeks>\\d+)(недел[а-я]{1,2}|н))))?(((числ[а-я] )(?<prefixdayofmonth>\\d+)|(?<suffixdayofmonth>\\d+)(числ[а-я]))?(( )?((?<onemonth>месяц)|(((месяц[а-я]{1,2}|м) )(?<prefixmonths>\\d+)|(?<suffixmonths>\\d+)(месяц[а-я]{1,2}|м)))))?)|((?<monthword>января|февраля|марта|апреля|мая|июня|июля|августа|сентября|октября|ноября|декабря) (?<day>\\d+)( (?<oneyear>год))?)|(?<dayofweek>понедельник[а-я]?|вторник[а-я]?|сред[[а-я][а-я]]?|четверг[а-я]?|пятниц[[а-я][а-я]]?|суббот[[а-я][а-я]]?|воскресень[[а-я][а-я]]?|пн|вт|ср|чт|пт|сб|вс))");
