...
public class TelegramMessageService implements MessageService {
    ...
    public void sendErrorMessage(long chatId, ReplyKeyboard replyKeyboard) {
        sendMessageAsync(
                new SendMessageContext(PriorityJob.Priority.MEDIUM)
                        .chatId(chatId)
                        .text(localisationService.getCurrentLocaleMessage(MessagesProperties.MESSAGE_ERROR))
    ...
    public void sendBotRestartedMessage(long chatId, ReplyKeyboard replyKeyboard) {
        sendMessageAsync(
                new SendMessageContext(PriorityJob.Priority.MEDIUM)
                        .chatId(chatId)
                        .text(localisationService.getCurrentLocaleMessage(MessagesProperties.MESSAGE_BOT_RESTARTED))
                        .replyKeyboard(replyKeyboard)
        );
    }
}
