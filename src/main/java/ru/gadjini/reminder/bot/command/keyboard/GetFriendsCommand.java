...
@Component
public class GetFriendsCommand implements KeyboardBotCommand, NavigableCallbackBotCommand {
    ...
    @Autowired
    public GetFriendsCommand(InlineKeyboardService inlineKeyboardService, FriendshipMessageBuilder friendshipMessageBuilder,
